---
The official guide does not use jQuery in order to keep things simple and the focus on the Web Socket guide.
This is my personal repository fork of this repository. I added jQuery in order to have the web client properly developed.
Now, under resources you will find the following:
resources   
 --> static
    --> ext
        --> jquery-2.1.4.js
...
So, all external javascript libraries can be found under the ext directory.    
---
